...
//                         <span className={`${day.cashVariance === 0 ? "text-gray-900" : day.cashVariance > 0 ? "text-green-600" : "text-red-600"}`}>{formatCurrency(day.cashVariance)}</span>
//                       </td>
//                       <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium">{day.autoReportGenerated && <ViewReportButton date={day.date} onClick={() => handleViewReport(day.date)} loading={reportLoading} />}</td>
//                     </tr>
//                   );
//                 })}
//             </tbody>
