...
export const salesAPI = {
  ...
  deleteSaleItem: (saleId: string, itemId: string, itemType: "material" | "menu") => api.delete<{ message: string }>(`/sales/${saleId}/items/${itemId}`, { params: { type: itemType } }),
  ...
  softDeleteSale: (saleId: string, itemId?: string, itemType?: "material" | "menu") => {
    const url = itemId && itemType ? `/sales/${saleId}/items/${itemId}?type=${itemType}` : `/sales/${saleId}`;
