...
export const PERMISSION_GROUPS = {
  ...
  "Reports & Analytics": {
    ...
    permissions: [PERMISSIONS.REPORTS_SALES, PERMISSIONS.REPORTS_INVENTORY, PERMISSIONS.REPORTS_FINANCIAL, PERMISSIONS.REPORTS_WASTE, PERMISSIONS.REPORTS_STAFF, PERMISSIONS.REPORTS_CUSTOMER, PERMISSIONS.REPORTS_EXPORT, PERMISSIONS.REPORTS_SCHEDULE, PERMISSIONS.ANALYTICS_DASHBOARD, PERMISSIONS.ANALYTICS_TRENDS, PERMISSIONS.ANALYTICS_FORECASTING, PERMISSIONS.ANALYTICS_PROFITABILITY]
  },
  "Financial Management": {
    icon: DollarSign,
