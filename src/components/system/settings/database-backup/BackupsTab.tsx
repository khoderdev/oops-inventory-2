...
import { backupAPI, BackupFormat, BackupInfo } from "@/api/backup.api";
    ...
    <>
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div className="flex flex-col w-fit">
          ...
          <div className="w-fit flex flex-col sm:flex-row sm:items-center sm:space-x-4">
            {lastRefresh && (
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center mb-4">
                Create your first backup to get started with database protection.
              </p>
                ...
                <div className="flex items-center justify-center space-x-2 pt-2">
                  {backup.formats.map(format => (
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      onClick={() => onDownload(backup, format)}
