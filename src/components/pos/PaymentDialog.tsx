        ...
        <div className="w-full h-full flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
              ...
              {isExactAmount && (
                <div className="w-full flex items-center justify-center animate-out scale-105 !mt-10">
                  <div className="w-fit text-center bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200 p-3 sm:p-4 rounded-xl">
