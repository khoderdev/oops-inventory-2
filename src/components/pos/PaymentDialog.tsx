          ...
          <DialogFooter className="flex-shrink-0 bg-gradient-to-r from-gray-50 to-slate-50 ">
            <div className="w-full space-y-3 bg-gray-200">
              <div className="flex w-full">
                <Button variant="outline" size="lg" onClick={onClose} className="flex-1 h-20 sm:h-20 text-base sm:text-2xl font-bold border-2 border-gray-300 hover:border-red-400 hover:bg-red-50 transition-all duration-200 rounded-none">
                  Cancel
                </Button>
                <Button
                  onClick={() => {
