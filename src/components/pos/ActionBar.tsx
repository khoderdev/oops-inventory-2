...
//       <Button className="w-14 h-14 rounded-full shadow-lg bg-teal-600 hover:bg-teal-700 text-white flex items-center justify-center" onClick={onToggle}>
//         {isOpen ? <ChevronUp className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
//       </Button>

//       {/* Action Menu */}
//       {isOpen && (
//         <div className="absolute bottom-16 right-0 bg-white border border-gray-200 rounded-lg shadow-lg p-2 w-48 max-h-fit overflow-y-auto">
...
//                 {button.label}
//                 {button.badgeCount && button.badgeCount > 0 && <span className="ml-auto bg-red-500 text-white text-xs rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1">{button.badgeCount > 99 ? "99+" : button.badgeCount}</span>}
