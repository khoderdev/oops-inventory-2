...
import { Eye, EyeOff, Circle, Square, RectangleHorizontal, Info, RefreshCw } from "lucide-react";
...
export const InactiveTablesModal: React.FC<TablesManagementModalProps> = ({
  isOpen,
  onClose,
  onTableActivated
}) => {
          ...
          {isRefreshing ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-gray-500 max-w-sm">
                No tables are available in the system.
              </p>
            </div>
          ) : (
