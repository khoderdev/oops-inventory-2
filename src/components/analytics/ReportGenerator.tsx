...
import { Download, FileText, TrendingUp, CalendarIcon } from "lucide-react";
...
import { StockEntry, Material, SaleRecord, ReportGeneratorProps } from "@/types/inventory";
import { getTableHeaders } from "@/utils/getTableHeaders";
import { REPORT_CONFIGS, ReportType } from "./configs";
import { ReportSummary } from "./ReportSummary";
import { ReportTable } from "./ReportTable";
import { generateStockPurchasesReport, generateSalesPerformanceReport, generateCostAnalysisReport, generateSupplierPerformanceReport, generateExpiryAlertsReport, generateCategoryAnalysisReport, generateMenuProfitabilityReport, generateSectionPerformanceReport, generateInventorySummaryReport } from "./generationFunctions";
        ...
        <CardContent className="flex-1 flex flex-col space-y-4 sm:space-y-6 min-h-0">
          ...
          {hasGenerated && !isChangingReportType && (
            <div className="flex-1 flex flex-col space-y-4 animate-in fade-in-50 duration-300 min-h-0">
              {/* Summary Cards for Inventory Summary */}
