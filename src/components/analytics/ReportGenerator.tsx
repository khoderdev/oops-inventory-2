...
//           break;
//         case "waste-report":
//           reportResults = await generateWasteReport(dateFrom, dateTo);
//           break;
//         default:
...
//                           <span className="truncate">{dateFrom ? formatDate(dateFrom) : "Pick a date"}</span>
//                         </Button>
//                       </PopoverTrigger>
...
//                           <CalendarIcon className="mr-2 h-4 w-4 flex-shrink-0" />
//                           <span className="truncate">{dateTo ? formatDate(dateTo) : "Pick a date"}</span>
//                         </Button>
//                       </PopoverTrigger>
//                       <PopoverContent className="w-auto p-0 max-w-[90vw]" align="start" side="bottom">
//                         <Calendar
