...
//       const validStockEntries = materialStockEntries.filter(entry => entry.costPerBaseUnit && entry.costPerBaseUnit > 0);
...
//       return parseFloat(String(material.costPerUnit || "0"));
//     },
//     [stockEntries]
//   );
...
//               </DialogHeader>
//               <MenuItemForm menuItem={editingMenuItem} materials={availableMaterials} categories={MENU_CATEGORIES} onSubmit={editingMenuItem ? handleUpdateMenuItem : handleAddMenuItem} onCancel={handleCancel} stockEntries={[]} />
//             </DialogContent>
//           </Dialog>
