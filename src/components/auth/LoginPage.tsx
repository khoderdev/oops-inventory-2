...
const LoginPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center space-y-4">
          ...
          <div className="h-64 w-96 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-gradient-to-br from-amber-50 to-orange-100 dark:from-gray-900 dark:to-gray-800 p-4 sm:p-6 lg:p-16 relative overflow-hidden">
      {/* Simplified background pattern */}

      <div className="max-w-md w-full space-y-8 z-10">
        <div className="text-center space-y-4 animate-in fade-in slide-in-from-top-10 duration-700">
          <div className="flex justify-center">
            <img src="/oops-icon.png" alt="" className="h-28 w-28" />
          </div>
          <h1 className="text-4xl font-serif font-bold text-gray-900 dark:text-gray-100 tracking-tight">oOps BackOffice</h1>
        </div>
