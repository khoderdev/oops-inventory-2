...
import { Trash2, RotateCw, Copy, Link, Users } from 'lucide-react';
...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
  ...
  const presetColors = [
    '#8B4513', '#654321', '#800000', '#2F4F4F', '#4A4A4A', '#708090',
    '#B8860B', '#CD853F', '#A0522D', '#8FBC8F', '#20B2AA', '#4682B4'
  ];
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => onUpdateFurniture(selectedFurniture.id, {
        ...
        <div className="space-y-3 pt-6 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg transition-colors duration-200"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-amber-100 hover:bg-amber-200 text-amber-700 rounded-lg transition-colors duration-200"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-lg transition-colors duration-200"
          >
