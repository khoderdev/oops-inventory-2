            ...
            <div className="grid grid-cols-2 gap-3">
              {items.map((template) => (
                <button
                  ...
                  className="p-4 border border-gray-200 rounded-lg hover:border-amber-300 hover:bg-amber-50 transition-all duration-200 group"
                >
                  ...
                  {template.seatingCapacity && (
                    <div className="text-xs text-gray-500">
                      Seats {template.seatingCapacity}
                    </div>
                  )}
                </button>
              ))}
