...
import { Material, MenuItemSale, Section, SectionAssignment, SoldItem, StockEntry } from "@/types/inventory";
  ...
  const completeSale = () => {
    ...
    selectedMenuItems.forEach(menuItem => {
      menuItem.ingredients.forEach(ingredient => {
        // Find the stock entry that contains this material
        // This is simplified - you might need more complex logic
        // to find the right stock entry to deduct from
    ...
    // Record sale
    onCompleteSale(cart, selectedMenuItems);
