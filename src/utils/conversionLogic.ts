...
export function calculatePackagedGoodCost(
...
export function isMassUnit(unit: string): boolean {
  return ['kg', 'gram', 'grams', 'lb', 'lbs'].includes(unit.toLowerCase());
}

export function isVolumeUnit(unit: string): boolean {
  return ['liter', 'liters', 'ml', 'gallon', 'gallons'].includes(unit.toLowerCase());
}
