...
export function getLogsTableHeaders(logType: LogType): string[] {
  const headerMap: Record<LogType, string[]> = {
    ...
    "failed-operations": ["Timestamp", "Action Type", "Material", "User", "Error Message", "Quantity", "Cost", "Description"],
    "recent-activity": ["Timestamp", "Action Type", "Material", "User", "Quantity", "Cost", "Status"],
    "today-logs": ["Time", "Action Type", "Material", "User", "Quantity", "Cost", "Status", "Description"],
    "action-type-logs": ["Timestamp", "Material", "User", "Stock Entry", "Quantity", "Cost", "Status", "Description"],
    "date-range-logs": ["Timestamp", "Action Type", "Material", "User", "Quantity", "Cost", "Status", "Description"],
    "summary-overview": ["Metric", "Value", "Percentage", "Change", "Status"],
    "search-logs": ["Timestamp", "Action Type", "Material", "User", "Quantity", "Cost", "Status", "Description", "Relevance"]
  };
