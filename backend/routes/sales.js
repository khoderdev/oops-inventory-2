...
router.delete("/:saleId/items/bulk", requirePermission("sales.update"), warnIfDayClosed, logSaleActivity, auditAction("sale_items_bulk_delete", "sale"), salesController.bulkDeleteSaleItems);
