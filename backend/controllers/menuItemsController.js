...
const menuItemsController = {
  ...
  getAllMenuItems: async (req, res, next) => {
    try {
      ...
      // Format response to match MenuItem interface
  ...
  createMenuItem: async (req, res, next) => {
    ...
    try {
      ...
      // Create menu item
      const menuItem = await MenuItem.create({ name, price, category, description }, { transaction });
      ...
      await menuItem.update(
        {
          ...
          price: price !== undefined ? name : menuItem.price,
